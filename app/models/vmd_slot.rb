class VmdSlot < ApplicationRecord
  ...
  def self.build_from_hash(slot)
    ...
    VmdSlot.create(
      ...
      slots_0_days: (slot[:appointment_schedules]["0_days".to_sym]),
      slots_2_days: (slot[:appointment_schedules]["2_days".to_sym]),
      slots_1_days: (slot[:appointment_schedules]["1_days".to_sym]),
      slots_7_days: (slot[:appointment_schedules]["7_days".to_sym]),
      slots_28_days: (slot[:appointment_schedules]["28_days".to_sym]),
      slots_49_days: (slot[:appointment_schedules]["49_days".to_sym]),
